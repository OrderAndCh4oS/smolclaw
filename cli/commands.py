...
SLASH_COMMANDS_HELP = "\n".join([
    ...
    "  /work-loop list          List Jira tickets and GitHub PRs worked by the agent",
    "  /work-loop status <id>   Show one work-loop ticket or PR",
    "  /work-loop tasks --project KEY    Start Jira task work",
    "  /work-loop reviews       Check GitHub review feedback for open agent PRs",
    "  /work-loop run --project KEY      Run reviews first, then Jira task work",
